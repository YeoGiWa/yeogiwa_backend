...
public class EventController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<GetEventResponse> getEventById(
            @PathVariable
    ...
    @GetMapping("/list")
    public ResponseEntity<List<GetEventResponse>> listEvents(@RequestParam("numOfRows") int numOfRows, @RequestParam("pageNo") int pageNo, @RequestParam("sort") Sort sort, @RequestParam("region") Region region, @RequestParam(name = "eventStartDate", required = false) String eventStartDate, @RequestParam(name = "eventEndDate", required = false) String eventEndDate) {
        ...
        List<GetEventResponse> event = eventService.listEvents(numOfRows, pageNo, sort, region, eventStartDate, eventEndDate);
    ...
    @GetMapping("/nearby")
    public ResponseEntity<List<GetEventResponse>> listEventsNearby(@RequestParam("numOfRows") int numOfRows, @RequestParam("pageNo") int pageNo, @RequestParam("sort") Sort sort, @RequestParam("mapX") String mapX, @RequestParam("mapY") String mapY, @RequestParam("radius") String radius) {
        List<GetEventResponse> event = eventService.listEventsNearby(numOfRows, pageNo, sort, mapX, mapY, radius);
