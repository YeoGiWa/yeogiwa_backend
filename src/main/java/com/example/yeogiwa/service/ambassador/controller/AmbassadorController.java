...
public class AmbassadorController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "앰배서더 정보를 성공적으로 조회한 경우"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "행사/축제의 앰배서더 목록을 성공적으로 조회한 경우"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "앰배서더로 등록 성공"),
